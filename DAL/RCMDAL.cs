...
namespace RCMAPI.DAL
{
    public class RCMDAL
    {
        ...
        {           
            ...
            {
                List<IDbDataParameter> objIDbDataParameters = new List<IDbDataParameter>();
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@CompanyId", (object)DBNull.Value, DbType.Int32, ParameterDirection.Output));
                objIDbDataParameters.Add(CreateParam1(objDataHelper, "@CompanyCode", null, 10, DbType.String, ParameterDirection.Output));
                ...
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@CompanyType", company.CompanyType, DbType.Int32, ParameterDirection.Input));
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@Address", company.Address, DbType.String, ParameterDirection.Input));
                ...
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@PinCode", company.PinCode, DbType.String, ParameterDirection.Input));
               
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@PhoneNumber", company.PhoneNumber, DbType.String, ParameterDirection.Input));
                ...
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@LicenseNumber", company.LicenseNumber, DbType.String, ParameterDirection.Input));
                objIDbDataParameters.Add(CreateParam(objDataHelper, "@CreditDays", company.CreditDays, DbType.Int32, ParameterDirection.Input));                
               

                int intRes = objDataHelper.RunSP("pr_SaveCompany", objIDbDataParameters.ToArray());
        ...
        public Company FetchCompany(int id)
        {
            ...
            try
            {
                ...
                using (DataSet dsCompanyList = objDataHelper.RunSPReturnDS("Pr_FetchCompany", objIDbDataParameters.ToArray()))
                {
                    if (dsCompanyList.Tables.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in dsCompanyList.Tables[0].Rows)
                        {
                            ...
                            objCompany.CompanyType = Convert.ToInt32(dr["StateID"]);
                            objCompany.CityId = Convert.ToInt32(dr["StateName"]);
                            objCompany.Address = Convert.ToString(dr["StateName"]);
                            objCompany.Address1 = Convert.ToString(dr["StateName"]);

                            objCompany.PinCode = Convert.ToString(dr["StateName"]);
                            objCompany.PhoneNumber = Convert.ToString(dr["StateName"]);
                            ...
                            objCompany.LicenseNumber = Convert.ToString(dr["StateName"]);
